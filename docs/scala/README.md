...
Buildpacks:
  ...
  heroku/dotnet              Heroku .NET                 0.14.0         https://github.com/heroku/buildpacks-dotnet
  heroku/go                  Heroku Go                   2.1.6          https://github.com/heroku/buildpacks-go
  ...
  heroku/nodejs              Heroku Node.js              5.3.2          https://github.com/heroku/buildpacks-nodejs
  heroku/php                 Heroku PHP                  1.3.1          https://github.com/heroku/buildpacks-php
  heroku/procfile            Heroku Procfile             4.2.1          https://github.com/heroku/buildpacks-procfile
  heroku/python              Heroku Python               3.0.1          https://github.com/heroku/buildpacks-python
...
524293b Upgrade to Play Framework 3.0.9 (#17)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- OpenJDK version resolution
  ...
  - Selected major version `17` resolves to `17.0.17`
  ...
  - Running `sbt compile stage`
      ...
      Downloading sbt launcher for 1.11.7:
        From  https://repo1.maven.org/maven2/org/scala-sbt/sbt-launch/1.11.7/sbt-launch-1.11.7.jar
          To  /layers/heroku_sbt/sbt-extras/launchers/1.11.7/sbt-launch.jar
      Downloading sbt launcher 1.11.7 md5 hash:
        From  https://repo1.maven.org/maven2/org/scala-sbt/sbt-launch/1.11.7/sbt-launch-1.11.7.jar.md5
          To  /layers/heroku_sbt/sbt-extras/launchers/1.11.7/sbt-launch.jar.md5
      /layers/heroku_sbt/sbt-extras/launchers/1.11.7/sbt-launch.jar: OK
      ...
      [info] welcome to sbt 1.11.7 (Azul Systems, Inc. Java 17.0.17)
      ...
      [info]   Compilation completed in 9.132s.
      [info] done compiling
      ...
      [info] done compiling
      [success] Total time: 11 s, completed Dec 29, 2025, 8:19:19 AM
      [info] Wrote /workspace/target/scala-2.13/scala-getting-started_2.13-1.0-SNAPSHOT.pom
      [success] Total time: 1 s, completed Dec 29, 2025, 8:19:20 AM

  - Done (37.7s)
- Done (finished in 37.7s)
...
8ba38a840bbe   my-image-name    latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
08:19:30,904 |-INFO in ch.qos.logback.classic.LoggerContext[default] - This is logback-classic version 1.5.18
08:19:30,906 |-INFO in ch.qos.logback.classic.util.ContextInitializer@43bc63a3 - No custom configurators were discovered as a service.
08:19:30,906 |-INFO in ch.qos.logback.classic.util.ContextInitializer@43bc63a3 - Trying to configure with ch.qos.logback.classic.joran.SerializedModelConfigurator
08:19:30,907 |-INFO in ch.qos.logback.classic.util.ContextInitializer@43bc63a3 - Constructed configurator of type class ch.qos.logback.classic.joran.SerializedModelConfigurator
08:19:30,915 |-INFO in ch.qos.logback.classic.LoggerContext[default] - Could NOT find resource [logback-test.scmo]
08:19:30,915 |-INFO in ch.qos.logback.classic.LoggerContext[default] - Could NOT find resource [logback.scmo]
08:19:30,926 |-INFO in ch.qos.logback.classic.util.ContextInitializer@43bc63a3 - ch.qos.logback.classic.joran.SerializedModelConfigurator.configure() call lasted 9 milliseconds. ExecutionStatus=INVOKE_NEXT_IF_ANY
08:19:30,926 |-INFO in ch.qos.logback.classic.util.ContextInitializer@43bc63a3 - Trying to configure with ch.qos.logback.classic.util.DefaultJoranConfigurator
08:19:30,927 |-INFO in ch.qos.logback.classic.util.ContextInitializer@43bc63a3 - Constructed configurator of type class ch.qos.logback.classic.util.DefaultJoranConfigurator
08:19:30,927 |-INFO in ch.qos.logback.classic.LoggerContext[default] - Could NOT find resource [logback-test.xml]
08:19:30,932 |-INFO in ch.qos.logback.classic.LoggerContext[default] - Found resource [logback.xml] at [file:/workspace/target/universal/stage/conf/logback.xml]
08:19:31,048 |-INFO in ch.qos.logback.core.model.processor.AppenderModelHandler - Processing appender named [FILE]
08:19:31,048 |-INFO in ch.qos.logback.core.model.processor.AppenderModelHandler - About to instantiate appender of type [ch.qos.logback.core.FileAppender]
08:19:31,056 |-INFO in ch.qos.logback.core.model.processor.ModelInterpretationContext@702657cc - value "./logs/application.log" substituted for "${application.home:-.}/logs/application.log"
08:19:31,057 |-INFO in ch.qos.logback.core.model.processor.ImplicitModelHandler - Assuming default type [ch.qos.logback.classic.encoder.PatternLayoutEncoder] for [encoder] property
08:19:31,100 |-INFO in ch.qos.logback.core.FileAppender[FILE] - File property is set to [./logs/application.log]
08:19:31,102 |-INFO in ch.qos.logback.core.model.processor.AppenderModelHandler - Processing appender named [STDOUT]
08:19:31,102 |-INFO in ch.qos.logback.core.model.processor.AppenderModelHandler - About to instantiate appender of type [ch.qos.logback.core.ConsoleAppender]
08:19:31,103 |-INFO in ch.qos.logback.core.model.processor.ImplicitModelHandler - Assuming default type [ch.qos.logback.classic.encoder.PatternLayoutEncoder] for [encoder] property
08:19:31,104 |-INFO in ch.qos.logback.core.ConsoleAppender[STDOUT] - BEWARE: Writing to the console can be very slow. Avoid logging to the 
08:19:31,104 |-INFO in ch.qos.logback.core.ConsoleAppender[STDOUT] - console in production environments, especially in high volume systems.
08:19:31,104 |-INFO in ch.qos.logback.core.ConsoleAppender[STDOUT] - See also https://logback.qos.ch/codes.html#slowConsole
08:19:31,104 |-INFO in ch.qos.logback.core.ConsoleAppender[STDOUT] - Enabling JANSI AnsiPrintStream for the console.
08:19:31,104 |-WARN in ch.qos.logback.core.ConsoleAppender[STDOUT] - Failed to create AnsiPrintStream. Falling back on the default stream. java.lang.ClassNotFoundException: org.fusesource.jansi.AnsiConsole
	...
	at 	at ch.qos.logback.core.ConsoleAppender.wrapWithJansi(ConsoleAppender.java:107)
	at 	at ch.qos.logback.core.ConsoleAppender.start(ConsoleAppender.java:97)
	...
	at 	at ch.qos.logback.classic.util.ContextInitializer.invokeConfigure(ContextInitializer.java:142)
	at 	at ch.qos.logback.classic.util.ContextInitializer.autoConfig(ContextInitializer.java:101)
	at 	at ch.qos.logback.classic.util.ContextInitializer.autoConfig(ContextInitializer.java:67)
	at 	at ch.qos.logback.classic.spi.LogbackServiceProvider.initializeLoggerContext(LogbackServiceProvider.java:51)
	at 	at ch.qos.logback.classic.spi.LogbackServiceProvider.initialize(LogbackServiceProvider.java:44)
	at 	at org.slf4j.LoggerFactory.bind(LoggerFactory.java:201)
	at 	at org.slf4j.LoggerFactory.performInitialization(LoggerFactory.java:187)
	at 	at org.slf4j.LoggerFactory.getProvider(LoggerFactory.java:511)
	at 	at org.slf4j.LoggerFactory.getILoggerFactory(LoggerFactory.java:497)
	at 	at org.slf4j.LoggerFactory.getLogger(LoggerFactory.java:446)
	at 	at org.slf4j.LoggerFactory.getLogger(LoggerFactory.java:472)
	at 	at play.api.Configuration$.<clinit>(Configuration.scala:196)
	at 	at play.core.server.ProdServerStart$.readServerConfigSettings(ProdServerStart.scala:101)
	at 	at play.core.server.ProdServerStart$.start(ProdServerStart.scala:41)
	at 	at play.core.server.ProdServerStart$.main(ProdServerStart.scala:28)
	at 	at play.core.server.ProdServerStart.main(ProdServerStart.scala)
08:19:31,104 |-INFO in ch.qos.logback.core.model.processor.AppenderModelHandler - Processing appender named [ASYNCFILE]
08:19:31,104 |-INFO in ch.qos.logback.core.model.processor.AppenderModelHandler - About to instantiate appender of type [ch.qos.logback.classic.AsyncAppender]
08:19:31,105 |-INFO in ch.qos.logback.core.model.processor.AppenderRefModelHandler - Attaching appender named [FILE] to ch.qos.logback.classic.AsyncAppender[ASYNCFILE]
08:19:31,106 |-INFO in ch.qos.logback.classic.AsyncAppender[ASYNCFILE] - Attaching appender named [FILE] to AsyncAppender.
08:19:31,108 |-INFO in ch.qos.logback.classic.AsyncAppender[ASYNCFILE] - Setting discardingThreshold to 51
08:19:31,109 |-INFO in ch.qos.logback.core.model.processor.AppenderModelHandler - Processing appender named [ASYNCSTDOUT]
08:19:31,109 |-INFO in ch.qos.logback.core.model.processor.AppenderModelHandler - About to instantiate appender of type [ch.qos.logback.classic.AsyncAppender]
08:19:31,109 |-INFO in ch.qos.logback.core.model.processor.AppenderRefModelHandler - Attaching appender named [STDOUT] to ch.qos.logback.classic.AsyncAppender[ASYNCSTDOUT]
08:19:31,109 |-INFO in ch.qos.logback.classic.AsyncAppender[ASYNCSTDOUT] - Attaching appender named [STDOUT] to AsyncAppender.
08:19:31,109 |-INFO in ch.qos.logback.classic.AsyncAppender[ASYNCSTDOUT] - Setting discardingThreshold to 51
08:19:31,110 |-INFO in ch.qos.logback.classic.model.processor.LoggerModelHandler - Setting level of logger [play] to INFO
08:19:31,110 |-INFO in ch.qos.logback.classic.model.processor.LoggerModelHandler - Setting level of logger [application] to DEBUG
08:19:31,110 |-INFO in ch.qos.logback.classic.model.processor.RootLoggerModelHandler - Setting level of ROOT logger to WARN
08:19:31,110 |-INFO in ch.qos.logback.core.model.processor.AppenderRefModelHandler - Attaching appender named [ASYNCFILE] to Logger[ROOT]
08:19:31,110 |-INFO in ch.qos.logback.core.model.processor.AppenderRefModelHandler - Attaching appender named [ASYNCSTDOUT] to Logger[ROOT]
08:19:31,111 |-INFO in ch.qos.logback.core.model.processor.DefaultProcessor@2d1ef81a - End of configuration.
08:19:31,111 |-INFO in ch.qos.logback.classic.joran.JoranConfigurator@4c402120 - Registering current configuration as safe fallback point
08:19:31,111 |-INFO in ch.qos.logback.classic.util.ContextInitializer@43bc63a3 - ch.qos.logback.classic.util.DefaultJoranConfigurator.configure() call lasted 184 milliseconds. ExecutionStatus=DO_NOT_INVOKE_NEXT_IF_ANY

2025-12-29 08:19:31 INFO  p.a.http.HttpErrorHandlerExceptions  Registering exception handler: guice-provision-exception-handler
2025-12-29 08:19:31 INFO  play.api.db.DefaultDBApi  Database [default] initialized
2025-12-29 08:19:31 INFO  play.api.db.HikariCPConnectionPool  Creating Pool for datasource 'default'
2025-12-29 08:19:32 INFO  play.api.Play  Application started (Prod) (no global state)
2025-12-29 08:19:32 INFO  play.core.server.PekkoHttpServer  Listening for HTTP on /[0:0:0:0:0:0:0:0]:5006
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
