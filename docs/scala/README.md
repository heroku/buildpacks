...
82232be Use Play 3.x and OpenJDK 25 (#19)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Running sbt build
  - Running `sbt compile stage`
      ...
      [info] welcome to sbt 1.11.7 (Azul Systems, Inc. Java 25.0.2)
      ...
      [info]   Compilation completed in 8.721s.
      [info] done compiling
      ...
      [info]       /_/               /____/
      [info] 
      [info] Version 3.0.9 running Java 25.0.2
      [info] 
      ...
      [info] done compiling
      [success] Total time: 8 s, completed Mar 9, 2026, 8:27:50 AM
      [info] Wrote /workspace/target/scala-2.13/scala-getting-started_2.13-1.0-SNAPSHOT.pom
      [success] Total time: 1 s, completed Mar 9, 2026, 8:27:51 AM

  - Done (33.6s)
- Done (finished in 33.6s)
...
dbf4817a0c06   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
2026-03-09 08:28:03 INFO  p.a.http.HttpErrorHandlerExceptions  Registering exception handler: guice-provision-exception-handler
WARNING: A terminally deprecated method in sun.misc.Unsafe has been called
...
WARNING: sun.misc.Unsafe::objectFieldOffset will be removed in a future release
2026-03-09 08:28:04 INFO  play.api.db.DefaultDBApi  Database [default] initialized
2026-03-09 08:28:04 INFO  play.api.db.HikariCPConnectionPool  Creating Pool for datasource 'default'
2026-03-09 08:28:05 INFO  play.api.Play  Application started (Prod) (no global state)
2026-03-09 08:28:05 INFO  play.core.server.PekkoHttpServer  Listening for HTTP on /[0:0:0:0:0:0:0:0]:5006
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
