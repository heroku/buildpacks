...
Buildpacks:
  ...
  heroku/dotnet              Heroku .NET                 0.15.0         https://github.com/heroku/buildpacks-dotnet
  heroku/go                  Heroku Go                   2.1.7          https://github.com/heroku/buildpacks-go
...
- Running sbt build
  - Running `sbt compile stage`
      ...
      [info]   Compilation completed in 9.862s.
      [info] done compiling
      ...
      [info] done compiling
      [success] Total time: 10 s, completed Jan 12, 2026, 8:20:03 AM
      [info] Wrote /workspace/target/scala-2.13/scala-getting-started_2.13-1.0-SNAPSHOT.pom
      [success] Total time: 1 s, completed Jan 12, 2026, 8:20:04 AM

  - Done (38.9s)
- Done (finished in 38.9s)
...
904a5b1ce9ec   my-image-name    latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
08:20:16,114 |-INFO in ch.qos.logback.classic.LoggerContext[default] - This is logback-classic version 1.5.18
08:20:16,115 |-INFO in ch.qos.logback.classic.util.ContextInitializer@43bc63a3 - No custom configurators were discovered as a service.
08:20:16,115 |-INFO in ch.qos.logback.classic.util.ContextInitializer@43bc63a3 - Trying to configure with ch.qos.logback.classic.joran.SerializedModelConfigurator
08:20:16,116 |-INFO in ch.qos.logback.classic.util.ContextInitializer@43bc63a3 - Constructed configurator of type class ch.qos.logback.classic.joran.SerializedModelConfigurator
08:20:16,123 |-INFO in ch.qos.logback.classic.LoggerContext[default] - Could NOT find resource [logback-test.scmo]
08:20:16,123 |-INFO in ch.qos.logback.classic.LoggerContext[default] - Could NOT find resource [logback.scmo]
08:20:16,132 |-INFO in ch.qos.logback.classic.util.ContextInitializer@43bc63a3 - ch.qos.logback.classic.joran.SerializedModelConfigurator.configure() call lasted 7 milliseconds. ExecutionStatus=INVOKE_NEXT_IF_ANY
08:20:16,132 |-INFO in ch.qos.logback.classic.util.ContextInitializer@43bc63a3 - Trying to configure with ch.qos.logback.classic.util.DefaultJoranConfigurator
08:20:16,132 |-INFO in ch.qos.logback.classic.util.ContextInitializer@43bc63a3 - Constructed configurator of type class ch.qos.logback.classic.util.DefaultJoranConfigurator
08:20:16,133 |-INFO in ch.qos.logback.classic.LoggerContext[default] - Could NOT find resource [logback-test.xml]
08:20:16,138 |-INFO in ch.qos.logback.classic.LoggerContext[default] - Found resource [logback.xml] at [file:/workspace/target/universal/stage/conf/logback.xml]
08:20:16,266 |-INFO in ch.qos.logback.core.model.processor.AppenderModelHandler - Processing appender named [FILE]
08:20:16,266 |-INFO in ch.qos.logback.core.model.processor.AppenderModelHandler - About to instantiate appender of type [ch.qos.logback.core.FileAppender]
08:20:16,274 |-INFO in ch.qos.logback.core.model.processor.ModelInterpretationContext@702657cc - value "./logs/application.log" substituted for "${application.home:-.}/logs/application.log"
08:20:16,275 |-INFO in ch.qos.logback.core.model.processor.ImplicitModelHandler - Assuming default type [ch.qos.logback.classic.encoder.PatternLayoutEncoder] for [encoder] property
08:20:16,318 |-INFO in ch.qos.logback.core.FileAppender[FILE] - File property is set to [./logs/application.log]
08:20:16,321 |-INFO in ch.qos.logback.core.model.processor.AppenderModelHandler - Processing appender named [STDOUT]
08:20:16,321 |-INFO in ch.qos.logback.core.model.processor.AppenderModelHandler - About to instantiate appender of type [ch.qos.logback.core.ConsoleAppender]
08:20:16,322 |-INFO in ch.qos.logback.core.model.processor.ImplicitModelHandler - Assuming default type [ch.qos.logback.classic.encoder.PatternLayoutEncoder] for [encoder] property
08:20:16,323 |-INFO in ch.qos.logback.core.ConsoleAppender[STDOUT] - BEWARE: Writing to the console can be very slow. Avoid logging to the 
08:20:16,323 |-INFO in ch.qos.logback.core.ConsoleAppender[STDOUT] - console in production environments, especially in high volume systems.
08:20:16,323 |-INFO in ch.qos.logback.core.ConsoleAppender[STDOUT] - See also https://logback.qos.ch/codes.html#slowConsole
08:20:16,323 |-INFO in ch.qos.logback.core.ConsoleAppender[STDOUT] - Enabling JANSI AnsiPrintStream for the console.
08:20:16,323 |-WARN in ch.qos.logback.core.ConsoleAppender[STDOUT] - Failed to create AnsiPrintStream. Falling back on the default stream. java.lang.ClassNotFoundException: org.fusesource.jansi.AnsiConsole
...
08:20:16,323 |-INFO in ch.qos.logback.core.model.processor.AppenderModelHandler - Processing appender named [ASYNCFILE]
08:20:16,323 |-INFO in ch.qos.logback.core.model.processor.AppenderModelHandler - About to instantiate appender of type [ch.qos.logback.classic.AsyncAppender]
08:20:16,325 |-INFO in ch.qos.logback.core.model.processor.AppenderRefModelHandler - Attaching appender named [FILE] to ch.qos.logback.classic.AsyncAppender[ASYNCFILE]
08:20:16,325 |-INFO in ch.qos.logback.classic.AsyncAppender[ASYNCFILE] - Attaching appender named [FILE] to AsyncAppender.
08:20:16,327 |-INFO in ch.qos.logback.classic.AsyncAppender[ASYNCFILE] - Setting discardingThreshold to 51
08:20:16,327 |-INFO in ch.qos.logback.core.model.processor.AppenderModelHandler - Processing appender named [ASYNCSTDOUT]
08:20:16,327 |-INFO in ch.qos.logback.core.model.processor.AppenderModelHandler - About to instantiate appender of type [ch.qos.logback.classic.AsyncAppender]
08:20:16,328 |-INFO in ch.qos.logback.core.model.processor.AppenderRefModelHandler - Attaching appender named [STDOUT] to ch.qos.logback.classic.AsyncAppender[ASYNCSTDOUT]
08:20:16,328 |-INFO in ch.qos.logback.classic.AsyncAppender[ASYNCSTDOUT] - Attaching appender named [STDOUT] to AsyncAppender.
08:20:16,328 |-INFO in ch.qos.logback.classic.AsyncAppender[ASYNCSTDOUT] - Setting discardingThreshold to 51
08:20:16,328 |-INFO in ch.qos.logback.classic.model.processor.LoggerModelHandler - Setting level of logger [play] to INFO
08:20:16,328 |-INFO in ch.qos.logback.classic.model.processor.LoggerModelHandler - Setting level of logger [application] to DEBUG
08:20:16,329 |-INFO in ch.qos.logback.classic.model.processor.RootLoggerModelHandler - Setting level of ROOT logger to WARN
08:20:16,329 |-INFO in ch.qos.logback.core.model.processor.AppenderRefModelHandler - Attaching appender named [ASYNCFILE] to Logger[ROOT]
08:20:16,329 |-INFO in ch.qos.logback.core.model.processor.AppenderRefModelHandler - Attaching appender named [ASYNCSTDOUT] to Logger[ROOT]
08:20:16,329 |-INFO in ch.qos.logback.core.model.processor.DefaultProcessor@2d1ef81a - End of configuration.
08:20:16,329 |-INFO in ch.qos.logback.classic.joran.JoranConfigurator@4c402120 - Registering current configuration as safe fallback point
08:20:16,329 |-INFO in ch.qos.logback.classic.util.ContextInitializer@43bc63a3 - ch.qos.logback.classic.util.DefaultJoranConfigurator.configure() call lasted 197 milliseconds. ExecutionStatus=DO_NOT_INVOKE_NEXT_IF_ANY

2026-01-12 08:20:16 INFO  p.a.http.HttpErrorHandlerExceptions  Registering exception handler: guice-provision-exception-handler
2026-01-12 08:20:17 INFO  play.api.db.DefaultDBApi  Database [default] initialized
2026-01-12 08:20:17 INFO  play.api.db.HikariCPConnectionPool  Creating Pool for datasource 'default'
2026-01-12 08:20:17 INFO  play.api.Play  Application started (Prod) (no global state)
2026-01-12 08:20:18 INFO  play.core.server.PekkoHttpServer  Listening for HTTP on /[0:0:0:0:0:0:0:0]:5006
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
