...
e5e5479 Fix GUSINFO metadata in CODEOWNERS (#20)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Running sbt build
  - Running `sbt compile stage`
      ...
      [info]   Compilation completed in 8.565s.
      [info] done compiling
      ...
      [info] done compiling
      [success] Total time: 8 s, completed Jun 8, 2026, 12:16:06 PM
      [info] Wrote /workspace/target/scala-2.13/scala-getting-started_2.13-1.0-SNAPSHOT.pom
      [success] Total time: 1 s, completed Jun 8, 2026, 12:16:07 PM
...
b12a56eb49da   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
2026-06-08 12:16:19 INFO  p.a.http.HttpErrorHandlerExceptions  Registering exception handler: guice-provision-exception-handler
WARNING: A terminally deprecated method in sun.misc.Unsafe has been called
...
WARNING: sun.misc.Unsafe::objectFieldOffset will be removed in a future release
2026-06-08 12:16:19 INFO  play.api.db.DefaultDBApi  Database [default] initialized
2026-06-08 12:16:19 INFO  play.api.db.HikariCPConnectionPool  Creating Pool for datasource 'default'
2026-06-08 12:16:20 INFO  play.api.Play  Application started (Prod) (no global state)
2026-06-08 12:16:21 INFO  play.core.server.PekkoHttpServer  Listening for HTTP on /[0:0:0:0:0:0:0:0]:5006
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
