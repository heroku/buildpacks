...
- Running sbt build
  - Running `sbt compile stage`
      ...
      [info]   Compilation completed in 6.071s.
      [info] done compiling
      ...
      [info] done compiling
      [success] Total time: 6 s, completed Sep 21, 2026, 8:31:02 AM
      [info] Wrote /workspace/target/scala-2.13/scala-getting-started_2.13-1.0-SNAPSHOT.pom
      [success] Total time: 1 s, completed Sep 21, 2026, 8:31:03 AM

  - Done (24.1s)
- Done (finished in 24.1s)
...
fba02e7e4afb   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
2026-09-21 08:31:18 INFO  p.a.http.HttpErrorHandlerExceptions  Registering exception handler: guice-provision-exception-handler
WARNING: A terminally deprecated method in sun.misc.Unsafe has been called
...
WARNING: sun.misc.Unsafe::objectFieldOffset will be removed in a future release
2026-09-21 08:31:19 INFO  play.api.db.DefaultDBApi  Database [default] initialized
2026-09-21 08:31:19 INFO  play.api.db.HikariCPConnectionPool  Creating Pool for datasource 'default'
2026-09-21 08:31:19 INFO  play.api.Play  Application started (Prod) (no global state)
2026-09-21 08:31:20 INFO  play.core.server.PekkoHttpServer  Listening for HTTP on /[0:0:0:0:0:0:0:0]:5006
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
