...
- Installing Node.js distribution
  - GET https://nodejs.org/download/release/v24.14.0/node-v24.14.0-linux-x64.tar.gz ... (0.6s)
  - Validating ... (< 0.1s)
  - Extracting .... (1.0s)
  - Verifying checksum
...
- Pruning dev dependencies
  - Running `npm prune`
      ...
      up to date, audited 367 packages in 594ms
...
4a1919f71edd   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
