...
- Installing Node.js distribution
  - GET https://nodejs.org/download/release/v24.18.0/node-v24.18.0-linux-x64.tar.gz ... (0.5s)
  - Validating ... (< 0.1s)
  - Extracting .... (1.0s)
  - Verifying checksum
...
- Pruning dev dependencies
  - Running `npm prune`
      ...
      up to date, audited 358 packages in 952ms
...
a87f23eca74d   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
