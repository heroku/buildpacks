...
- Installing Node.js distribution
  - GET https://nodejs.org/download/release/v24.16.0/node-v24.16.0-linux-x64.tar.gz .... (1.0s)
  - Validating ... (< 0.1s)
  - Extracting .... (1.0s)
  - Verifying checksum
...
- Pruning dev dependencies
  - Running `npm prune`
      ...
      up to date, audited 357 packages in 592ms
...
50cbf20e75b5   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
