...
15d898a Remove @joshlewis from CODEOWNERS (#365)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
heroku/nodejs-npm-install 4.1.0
...
- Checking Node.js version
  - Detected Node.js version range: `>=20.0.0 <21.0.0-0||>=22.0.0 <23.0.0-0||>=24.0.0 <25.0.0-0`
  - Resolved Node.js version: `24.4.1`
- Installing Node.js distribution
  - GET https://nodejs.org/download/release/v24.4.1/node-v24.4.1-linux-x64.tar.gz ... (OK)
  - Downloading ... (0.3s)
  - Verifying checksum
  - Extracting Node.js `24.4.1 (linux-amd64)`
  - Installing Node.js `24.4.1 (linux-amd64)` ... (< 0.1s)
- Done (finished in 1.6s)

## Heroku Node.js npm Install

- Installing node modules
  - Using npm version `11.4.2`
  - Creating npm cache
  ...
  - Running `npm ci`
      ...
      added 389 packages, and audited 390 packages in 3s
...
- Pruning dev dependencies
  - Running `npm prune`
      ...
      up to date, audited 83 packages in 677ms
...
7fe60cb9a656   my-image-name    latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
