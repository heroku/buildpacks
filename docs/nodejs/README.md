...
- Checking Node.js version
  ...
  - Resolved Node.js version: `26.5.0`
- Installing Node.js distribution
  - GET https://nodejs.org/download/release/v26.5.0/node-v26.5.0-linux-x64.tar.gz ... (0.5s)
  - Validating ... (< 0.1s)
  - Extracting .... (1.0s)
  - Verifying checksum
  - Extracting Node.js `26.5.0 (linux-amd64)`
  - Installing Node.js `26.5.0 (linux-amd64)` ... (< 0.1s)
- Determining npm package information
  - Found `engines.npm` version `12.x` declared in `package.json`
  - GET https://registry.npmjs.org/npm ... (0.2s)
  - Resolved npm version `12.x` to `12.0.1`
- Installing npm
  - GET https://registry.npmjs.org/npm/-/npm-12.0.1.tgz ... (< 0.1s)
  - Extracting ... (0.1s)
  - Successfully installed `npm@12.0.1`
- Installing node modules
  - Using npm version `12.0.1`
  - Creating npm cache
...
- Pruning dev dependencies
  - Running `npm prune`
      ...
      up to date, audited 360 packages in 703ms
...
28836770097e   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
