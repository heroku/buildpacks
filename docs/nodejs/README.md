...
- Installing node modules
  ...
  - Running `npm ci`
      ...
      added 357 packages, and audited 358 packages in 3s
...
- Pruning dev dependencies
  - Running `npm prune`
      ...
      up to date, audited 358 packages in 625ms
...
b366fda9a6ea   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
