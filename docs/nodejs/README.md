...
- Checking Node.js version
  ...
  - Resolved Node.js version: `26.5.1`
- Installing Node.js distribution
  - GET https://nodejs.org/download/release/v26.5.1/node-v26.5.1-linux-x64.tar.gz ... (0.3s)
  - Validating ... (< 0.1s)
  - Extracting .... (1.0s)
  - Verifying checksum
  - Extracting Node.js `26.5.1 (linux-amd64)`
  - Installing Node.js `26.5.1 (linux-amd64)` ... (< 0.1s)
...
- Pruning dev dependencies
  - Running `npm prune`
      ...
      up to date, audited 360 packages in 713ms
...
7c7f6e7cda1d   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
