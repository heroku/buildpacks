...
- Checking Node.js version
  ...
  - Resolved Node.js version: `24.8.0`
- Installing Node.js distribution
  - GET https://nodejs.org/download/release/v24.8.0/node-v24.8.0-linux-x64.tar.gz ... (OK)
  - Downloading ... (0.4s)
  - Verifying checksum
  - Extracting Node.js `24.8.0 (linux-amd64)`
  - Installing Node.js `24.8.0 (linux-amd64)` ... (< 0.1s)
...
- Pruning dev dependencies
  - Running `npm prune`
      ...
      up to date, audited 83 packages in 740ms
...
d3085a45734b   my-image-name    latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
