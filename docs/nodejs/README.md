...
- Checking Node.js version
  ...
  - Resolved Node.js version: `26.8.2`
- Installing Node.js distribution
  - GET https://nodejs.org/download/release/v26.8.2/node-v26.8.2-linux-x64.tar.gz ... (0.2s)
  - Validating ... (< 0.1s)
  - Extracting .... (1.2s)
  - Verifying checksum
  - Extracting Node.js `26.8.2 (linux-amd64)`
  - Installing Node.js `26.8.2 (linux-amd64)` ... (< 0.1s)
...
- Pruning dev dependencies
  - Running `npm prune`
      ...
      up to date, audited 346 packages in 791ms
...
cb36415e7e9a   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
