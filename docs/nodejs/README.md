...
- Checking Node.js version
  ...
  - Resolved Node.js version: `24.10.0`
- Installing Node.js distribution
  - GET https://nodejs.org/download/release/v24.10.0/node-v24.10.0-linux-x64.tar.gz ... (OK)
  - Downloading ... (0.9s)
  - Verifying checksum
  - Extracting Node.js `24.10.0 (linux-amd64)`
  - Installing Node.js `24.10.0 (linux-amd64)` ... (< 0.1s)
...
- Pruning dev dependencies
  - Running `npm prune`
      ...
      removed 308 packages, and audited 83 packages in 729ms
...
7d7a79fd9c37   my-image-name    latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
