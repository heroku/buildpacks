...
```
$ git clone https://github.com/heroku/nodejs-getting-started
...
```
$ git log --oneline -n1
22d0607 Bump body-parser from 2.2.1 to 2.3.0 (#410)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Checking Node.js version
  ...
  - Resolved Node.js version: `26.7.0`
- Installing Node.js distribution
  - GET https://nodejs.org/download/release/v26.7.0/node-v26.7.0-linux-x64.tar.gz ... (0.4s)
  - Validating ... (< 0.1s)
  - Extracting .... (1.0s)
  - Verifying checksum
  - Extracting Node.js `26.7.0 (linux-amd64)`
  - Installing Node.js `26.7.0 (linux-amd64)` ... (< 0.1s)
...
- Pruning dev dependencies
  - Running `npm prune`
      ...
      up to date, audited 360 packages in 718ms
...
Adding layer 'heroku/nodejs:npm_engine'
...
Adding cache layer 'heroku/nodejs:npm_engine'
Adding cache layer 'heroku/nodejs:npm_packument'
...
fe8c153dabd9   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
/layers/heroku_nodejs/npm_engine/bin/npm
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
