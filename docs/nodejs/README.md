...
- Installing Node.js distribution
  - GET https://nodejs.org/download/release/v24.17.0/node-v24.17.0-linux-x64.tar.gz ... (0.3s)
  - Validating ... (< 0.1s)
  - Extracting .... (1.0s)
  - Verifying checksum
...
- Installing node modules
  ...
  - Running `npm ci`
      ...
      added 357 packages, and audited 358 packages in 4s
...
- Pruning dev dependencies
  - Running `npm prune`
      ...
      up to date, audited 358 packages in 901ms
...
ea800ec2b7d5   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
