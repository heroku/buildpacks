...
f87eba0 Bump express from 5.1.0 to 5.2.1 in the node-dependencies group (#381)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Installing Node.js distribution
  - GET https://nodejs.org/download/release/v24.12.0/node-v24.12.0-linux-x64.tar.gz ... (0.6s)
  - Validating ... (< 0.1s)
  - Extracting ... (0.7s)
  - Verifying checksum
...
- Pruning dev dependencies
  - Running `npm prune`
      ...
      up to date, audited 367 packages in 674ms
...
0e5deb1c3387   my-image-name    latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
