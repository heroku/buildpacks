...
f047186 Bump jest from 30.0.3 to 30.0.5 in the node-dependencies group (#370)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
heroku/nodejs-npm-install 4.1.4
...
- Installing Node.js distribution
  - GET https://nodejs.org/download/release/v24.7.0/node-v24.7.0-linux-x64.tar.gz ... (OK)
  - Downloading ... (0.6s)
  - Verifying checksum
  - Extracting Node.js `24.7.0 (linux-amd64)`
  - Installing Node.js `24.7.0 (linux-amd64)` ... (< 0.1s)
- Done (finished in 2.0s)

## Heroku Node.js npm Install

- Installing node modules
  - Using npm version `11.5.1`
  - Creating npm cache
...
- Pruning dev dependencies
  - Running `npm prune`
      ...
      up to date, audited 83 packages in 654ms
...
40e778c0605c   my-image-name    latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
