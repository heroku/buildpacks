...
4758f5e Bump jest from 30.0.5 to 30.1.3 in the node-dependencies group (#374)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Checking Node.js version
  ...
  - Resolved Node.js version: `24.9.0`
- Installing Node.js distribution
  - GET https://nodejs.org/download/release/v24.9.0/node-v24.9.0-linux-x64.tar.gz ... (OK)
  - Downloading ... (0.4s)
  - Verifying checksum
  - Extracting Node.js `24.9.0 (linux-amd64)`
  - Installing Node.js `24.9.0 (linux-amd64)` ... (< 0.1s)
...
- Pruning dev dependencies
  - Running `npm prune`
      ...
      up to date, audited 83 packages in 732ms
...
c9203dfa158c   my-image-name    latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
