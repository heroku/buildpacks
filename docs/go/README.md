...
23911df Bump github.com/quic-go/quic-go from 0.59.0 to 0.59.1 (#96)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Reading build configuration
  ...
  - Resolved Go version: go1.25.11 (linux-amd64)
- Installing Go distribution
  - Installing go1.25.11 (linux-amd64) from https://go.dev/dl/go1.25.11.linux-amd64.tar.gz
...
e3dffebef900   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
