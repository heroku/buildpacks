...
- Reading build configuration
  ...
  - Resolved Go version: go1.25.7 (linux-amd64)
- Installing Go distribution
  - Installing go1.25.7 (linux-amd64) from https://go.dev/dl/go1.25.7.linux-amd64.tar.gz
...
5997b10b89fc   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
