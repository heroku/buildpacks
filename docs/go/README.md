...
98ac31f Update repo metadata (#73)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
Resolved Go version: go1.23.8 (linux-amd64)

[Installing Go distribution]
Installing go1.23.8 (linux-amd64) from https://go.dev/dl/go1.23.8.linux-amd64.tar.gz
...
f835b47d3bf8   my-image-name    latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
