...
- Reading build configuration
  - Detected Go version requirement: =1.25
  - Resolved Go version: go1.25.12 (linux-amd64)
- Installing Go distribution
  - Installing go1.25.12 (linux-amd64) from https://go.dev/dl/go1.25.12.linux-amd64.tar.gz
- Building Go binaries
  - Creating new Go modules cache
  - Creating Go build cache
  - Resolving Go modules
  - Running `go list -tags heroku`
      ...
      go: downloading go.mongodb.org/mongo-driver/v2 v2.8.0
...
508756685bf6   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
