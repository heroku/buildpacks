...
- Reading build configuration
  ...
  - Resolved Go version: go1.25.9 (linux-amd64)
- Installing Go distribution
  - Installing go1.25.9 (linux-amd64) from https://go.dev/dl/go1.25.9.linux-amd64.tar.gz
...
56d1ac5fb1d4   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
