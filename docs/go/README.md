...
b32f38b Bump github.com/heroku/x in the go-dependencies group (#95)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Reading build configuration
  ...
  - Resolved Go version: go1.25.10 (linux-amd64)
- Installing Go distribution
  - Installing go1.25.10 (linux-amd64) from https://go.dev/dl/go1.25.10.linux-amd64.tar.gz
