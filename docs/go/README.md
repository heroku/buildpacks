...
- Reading build configuration
  ...
  - Resolved Go version: go1.24.13 (linux-amd64)
- Installing Go distribution
  - Installing go1.24.13 (linux-amd64) from https://go.dev/dl/go1.24.13.linux-amd64.tar.gz
...
ca399fac2df8   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
