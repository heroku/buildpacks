...
ecf5e04 Avoid dependency vendoring (#85)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Reading build configuration
  ...
  - Resolved Go version: go1.24.8 (linux-amd64)
- Installing Go distribution
  - Installing go1.24.8 (linux-amd64) from https://go.dev/dl/go1.24.8.linux-amd64.tar.gz
...
cc8c7b09d962   my-image-name    latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
