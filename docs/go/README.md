...
aca8c45 Bump golang.org/x/crypto from 0.40.0 to 0.45.0 (#88)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Reading build configuration
  - Detected Go version requirement: =1.24
  - Resolved Go version: go1.24.10 (linux-amd64)
- Installing Go distribution
  - Installing go1.24.10 (linux-amd64) from https://go.dev/dl/go1.24.10.linux-amd64.tar.gz
...
27463560d46f   my-image-name    latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
