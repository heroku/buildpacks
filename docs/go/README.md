...
fb297a5 Bump github.com/heroku/x in the go-dependencies group (#80)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Reading build configuration
  ...
  - Resolved Go version: go1.23.12 (linux-amd64)
- Installing Go distribution
  - Installing go1.23.12 (linux-amd64) from https://go.dev/dl/go1.23.12.linux-amd64.tar.gz
...
7be70d22ef5d   my-image-name    latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
