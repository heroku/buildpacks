...
9b5bf80 Bump activesupport from 8.1.2 to 8.1.2.1 (#222)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
2e89e333bbf7   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Installing Node.js distribution
  - GET https://nodejs.org/download/release/v24.14.1/node-v24.14.1-linux-x64.tar.gz ... (0.5s)
  - Validating ... (< 0.1s)
  - Extracting .... (1.0s)
  - Verifying checksum
