...
cd5e95f Bump puma from 7.2.0 to 8.0.1 (#228)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
6c90bccf1ab4   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Installing Node.js distribution
  - GET https://nodejs.org/download/release/v24.15.0/node-v24.15.0-linux-x64.tar.gz ... (0.2s)
  - Validating ... (< 0.1s)
  - Extracting ... (0.8s)
  - Verifying checksum
