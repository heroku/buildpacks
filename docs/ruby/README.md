...
7507b49 Bump the ruby-dependencies group with 2 updates (#212)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Bundler version `4.0.5` from `Gemfile.lock`
  - Running `gem install bundler --version 4.0.5 --install-dir /layers/heroku_ruby/bundler --bindir /layers/heroku_ruby/bundler/bin --force --no-document --env-shebang` .... (1.6s)
- Bundle install gems
...
2d144c3558e6   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
[1] - Worker 1 (PID: 18) booted in 0.06s, phase: 0
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Installing Node.js distribution
  - GET https://nodejs.org/download/release/v24.14.0/node-v24.14.0-linux-x64.tar.gz ... (0.2s)
  - Validating ... (< 0.1s)
  - Extracting ... (0.8s)
  - Verifying checksum
