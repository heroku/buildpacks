...
456b655 Bump net-imap from 0.6.2 to 0.6.4 (#229)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Bundle install gems
  - Running `BUNDLE_FROZEN="1" BUNDLE_GEMFILE="/workspace/Gemfile" BUNDLE_WITHOUT="development:test" bundle install`
      ...
      Fetching puma 8.0.1
      Installing puma 8.0.1 with native extensions
      ...
      Fetching bootsnap 1.24.1
      Installing bootsnap 1.24.1 with native extensions
...
374767ffcf90   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Installing Node.js distribution
  - GET https://nodejs.org/download/release/v24.16.0/node-v24.16.0-linux-x64.tar.gz ... (0.8s)
  - Validating ... (< 0.1s)
  - Extracting .... (1.0s)
  - Verifying checksum
