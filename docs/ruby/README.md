...
9143ecd Upgrade to the latest Ruby (#205)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
2fb76e357458   my-image-name    latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
[1] - Worker 1 (PID: 17) booted in 0.01s, phase: 0
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Installing Node.js distribution
  - GET https://nodejs.org/download/release/v24.12.0/node-v24.12.0-linux-x64.tar.gz .... (1.0s)
  - Validating ... (< 0.1s)
  - Extracting ... (0.7s)
  - Verifying checksum
