...
fad8cb4 Bump rack from 3.2.5 to 3.2.6 (#224)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Bundler version `4.0.5` from `Gemfile.lock`
  - Running `gem install bundler --version 4.0.5 --install-dir /layers/heroku_ruby/bundler --bindir /layers/heroku_ruby/bundler/bin --force --no-document --env-shebang` .... (1.4s)
- Bundle install gems
...
7b750c4c8353   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Checking Node.js version
  ...
  - Resolved Node.js version: `24.14.1`
- Installing Node.js distribution
  - GET https://nodejs.org/download/release/v24.14.1/node-v24.14.1-linux-x64.tar.gz ... (0.3s)
  - Validating ... (< 0.1s)
  - Extracting .... (1.0s)
  - Verifying checksum
  - Extracting Node.js `24.14.1 (linux-amd64)`
  - Installing Node.js `24.14.1 (linux-amd64)` ... (< 0.1s)
