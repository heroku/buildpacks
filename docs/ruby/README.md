...
2da21a9794e7   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Installing Node.js distribution
  - GET https://nodejs.org/download/release/v24.18.0/node-v24.18.0-linux-x64.tar.gz ... (0.2s)
  - Validating ... (< 0.1s)
  - Extracting .... (1.0s)
  - Verifying checksum
