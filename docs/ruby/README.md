...
```
$ git log --oneline -n1
5a28426 Bump websocket-driver from 0.8.0 to 0.8.1 (#239)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Bundle install gems
  - Running `BUNDLE_FROZEN="1" BUNDLE_GEMFILE="/workspace/Gemfile" BUNDLE_WITHOUT="development:test" bundle install`
      ...
      Fetching msgpack 1.8.3
      Installing msgpack 1.8.3 with native extensions
      ...
      Fetching websocket-driver 0.8.1
      Installing websocket-driver 0.8.1 with native extensions
      ...
      Fetching net-imap 0.6.4.1
      Installing net-imap 0.6.4.1
      ...
      Installing activerecord 8.1.2.1
      Fetching actionpack 8.1.2.1
      Installing actionpack 8.1.2.1
      ...
      Fetching activestorage 8.1.2.1
      Installing activestorage 8.1.2.1
      Fetching actionmailbox 8.1.2.1
      Installing actionmailbox 8.1.2.1
      Fetching action_text-trix 2.1.18
      Fetching importmap-rails 2.2.3
      Installing importmap-rails 2.2.3
      Installing action_text-trix 2.1.18
      Fetching actiontext 8.1.2.1
      Installing actiontext 8.1.2.1
      Fetching rails 8.1.2.1
      Installing rails 8.1.2.1
...
- Rake assets install
  ...
  - Running `rake assets:precompile assets:clean --trace`
      ...
      ** Execute assets:clean
      ...
      Writing application-d8a8613a.js
...
b7b4410d39e2   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
WARNING: IPv6 bind requested but no non-loopback IPv6 interface was detected
[1] Puma starting in cluster mode...
[1] * Puma version: 8.0.2 ("Into the Arena")
[1] * Ruby version: ruby 3.4.9 (2026-03-11 revision 76cca827ab) +PRISM [x86_64-linux]
[1] *  Min threads: 3
[1] *  Max threads: 3
...
[1] * Listening on http://0.0.0.0:5006
[1] Use Ctrl-C to stop
[1] - Worker 0 (PID: 14) booted in 0.01s, phase: 0
[1] - Worker 1 (PID: 18) booted in 0.01s, phase: 0
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Checking Node.js version
  ...
  - Resolved Node.js version: `24.19.0`
- Installing Node.js distribution
  - GET https://nodejs.org/download/release/v24.19.0/node-v24.19.0-linux-x64.tar.gz ... (0.4s)
  - Validating ... (< 0.1s)
  - Extracting .... (1.0s)
  - Verifying checksum
  - Extracting Node.js `24.19.0 (linux-amd64)`
  - Installing Node.js `24.19.0 (linux-amd64)` ... (< 0.1s)
- Determining npm package information
  - No npm version requested
  - Using bundled npm version `11.17.0`
