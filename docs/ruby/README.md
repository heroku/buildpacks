...
```
$ git log --oneline -n1
f6c368e Bump rails-html-sanitizer from 1.7.0 to 1.7.1 (#243)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
7eb3a3fb8df5   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Installing Node.js distribution
  - GET https://nodejs.org/download/release/v24.19.0/node-v24.19.0-linux-x64.tar.gz ... (0.5s)
  - Validating ... (< 0.1s)
  - Extracting .... (1.0s)
  - Verifying checksum
