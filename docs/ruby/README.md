...
7069b3d Upgrade to Rails 8.1 (#209)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Bundler version `4.0.5` from `Gemfile.lock`
  - Running `gem install bundler --version 4.0.5 --install-dir /layers/heroku_ruby/bundler --bindir /layers/heroku_ruby/bundler/bin --force --no-document --env-shebang` ... (0.7s)
- Bundle install gems
  - Running `BUNDLE_FROZEN="1" BUNDLE_GEMFILE="/workspace/Gemfile" BUNDLE_WITHOUT="development:test" bundle install`
      ...
      Fetching bootsnap 1.21.1
      Installing bootsnap 1.21.1 with native extensions
...
2b7d9881b1f6   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Checking Node.js version
  ...
  - Resolved Node.js version: `24.13.1`
- Installing Node.js distribution
  - GET https://nodejs.org/download/release/v24.13.1/node-v24.13.1-linux-x64.tar.gz .... (1.3s)
  - Validating ... (< 0.1s)
  - Extracting ... (0.9s)
  - Verifying checksum
  - Extracting Node.js `24.13.1 (linux-amd64)`
  - Installing Node.js `24.13.1 (linux-amd64)` ... (< 0.1s)
