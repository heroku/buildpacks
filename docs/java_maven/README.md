...
Buildpacks:
  ...
  heroku/gradle              Heroku Gradle               7.0.12         https://github.com/heroku/buildpacks-jvm
  heroku/java                Heroku Java                 7.0.12         https://github.com/heroku/buildpacks-jvm
  heroku/jvm                 Heroku OpenJDK              7.0.12         https://github.com/heroku/buildpacks-jvm
  heroku/maven               Heroku Maven                7.0.12         https://github.com/heroku/buildpacks-jvm
  ...
  heroku/sbt                 Heroku sbt                  7.0.12         https://github.com/heroku/buildpacks-jvm
  heroku/scala               Heroku Scala                7.0.12         https://github.com/heroku/buildpacks-jvm
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- OpenJDK version resolution
  ...
  - Selected major version `17` resolves to `17.0.19`
...
- Running Maven build
  - Running `./mvnw -DskipTests clean install`
      ...
      [INFO] Downloaded from central: https://repo.maven.apache.org/maven2/org/springframework/boot/spring-boot-starter-parent/4.1.0/spring-boot-starter-parent-4.1.0.pom (14 kB at 139 kB/s)
      ...
      [INFO] Downloaded from central: https://repo.maven.apache.org/maven2/org/springframework/boot/spring-boot-dependencies/4.1.0/spring-boot-dependencies-4.1.0.pom (142 kB at 720 kB/s)
      ...
      [INFO] Downloaded from central: https://repo.maven.apache.org/maven2/org/apache/activemq/activemq-bom/6.2.6/activemq-bom-6.2.6.pom (7.9 kB at 225 kB/s)
      ...
      [INFO] Downloaded from central: https://repo.maven.apache.org/maven2/org/apache/artemis/artemis-bom/2.53.0/artemis-bom-2.53.0.pom (18 kB at 519 kB/s)
      ...
      [INFO] Downloaded from central: https://repo.maven.apache.org/maven2/org/apache/apache/37/apache-37.pom (26 kB at 640 kB/s)
...
...
      ...
      [INFO] Downloaded from central: https://repo.maven.apache.org/maven2/org/apache/maven/resolver/maven-resolver-api/1.9.22/maven-resolver-api-1.9.22.pom (2.2 kB at 69 kB/s)
      ...
      [INFO] Downloaded from central: https://repo.maven.apache.org/maven2/org/codehaus/plexus/plexus/17/plexus-17.pom (28 kB at 1.0 MB/s)
      ...
      [INFO] Downloaded from central: https://repo.maven.apache.org/maven2/org/apache/maven/resolver/maven-resolver-util/1.9.22/maven-resolver-util-1.9.22.jar (196 kB at 7.0 MB/s)
      [INFO] Downloaded from central: https://repo.maven.apache.org/maven2/org/codehaus/plexus/plexus-utils/4.0.1/plexus-utils-4.0.1.jar (193 kB at 6.9 MB/s)
      [INFO] Downloaded from central: https://repo.maven.apache.org/maven2/org/apache/maven/resolver/maven-resolver-api/1.9.22/maven-resolver-api-1.9.22.jar (157 kB at 5.2 MB/s)
      ...
      [INFO] Finished at: 2026-07-20T09:15:59Z
      [INFO] ------------------------------------------------------------------------

  - Done (14.9s)
- Running `./mvnw dependency:list` quietly
  - Done (7.9s)
- Done (finished in 22.8s)
...
c9526412c98f   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
2026-07-20T09:16:19.099Z  INFO 1 --- [           main] c.heroku.java.GettingStartedApplication  : Starting GettingStartedApplication v1.0.0-SNAPSHOT using Java 17.0.19 with PID 1 (/workspace/target/java-getting-started-1.0.0-SNAPSHOT.jar started by heroku in /workspace)
2026-07-20T09:16:19.110Z  INFO 1 --- [           main] c.heroku.java.GettingStartedApplication  : No active profile set, falling back to 1 default profile: "default"
2026-07-20T09:16:20.071Z  INFO 1 --- [           main] o.s.boot.tomcat.TomcatWebServer          : Tomcat initialized with port 5006 (http)
2026-07-20T09:16:20.086Z  INFO 1 --- [           main] o.apache.catalina.core.StandardService   : Starting service [Tomcat]
2026-07-20T09:16:20.087Z  INFO 1 --- [           main] o.apache.catalina.core.StandardEngine    : Starting Servlet engine: [Apache Tomcat/11.0.22]
2026-07-20T09:16:20.117Z  INFO 1 --- [           main] b.w.c.s.WebApplicationContextInitializer : Root WebApplicationContext: initialization completed in 938 ms
2026-07-20T09:16:20.255Z  INFO 1 --- [           main] o.s.b.w.a.WelcomePageHandlerMapping      : Adding welcome page template: index
2026-07-20T09:16:20.583Z  INFO 1 --- [           main] o.s.boot.tomcat.TomcatWebServer          : Tomcat started on port 5006 (http) with context path '/'
2026-07-20T09:16:20.596Z  INFO 1 --- [           main] c.heroku.java.GettingStartedApplication  : Started GettingStartedApplication in 1.896 seconds (process running for 2.321)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
