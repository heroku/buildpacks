...
Builder 'heroku/builder:26' is now the default builder
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
The current default builder is 'heroku/builder:26'
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
Buildpacks:
  ...
  heroku/dotnet              Heroku .NET                 1.0.14         https://github.com/heroku/buildpacks-dotnet
  heroku/go                  Heroku Go                   4.0.0          https://github.com/heroku/buildpacks-go
  heroku/gradle              Heroku Gradle               7.0.13         https://github.com/heroku/buildpacks-jvm
  heroku/java                Heroku Java                 7.0.13         https://github.com/heroku/buildpacks-jvm
  heroku/jvm                 Heroku OpenJDK              7.0.13         https://github.com/heroku/buildpacks-jvm
  heroku/maven               Heroku Maven                7.0.13         https://github.com/heroku/buildpacks-jvm
  heroku/nodejs              Heroku Node.js              5.7.13         https://github.com/heroku/buildpacks-nodejs
  ...
  heroku/python              Heroku Python               6.5.6          https://github.com/heroku/buildpacks-python
  heroku/ruby                Heroku Ruby                 12.4.1         https://github.com/heroku/buildpacks-ruby
  heroku/sbt                 Heroku sbt                  7.0.13         https://github.com/heroku/buildpacks-jvm
  heroku/scala               Heroku Scala                7.0.13         https://github.com/heroku/buildpacks-jvm
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
```
$ git log --oneline -n1
bba7dfd Switch LICENSE from MIT to the Unlicense (#245)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- OpenJDK version resolution
  ...
  - Selected major version `17` resolves to `17.0.20`
...
- Running Maven build
  - Running `./mvnw -DskipTests clean install`
      ...
      [INFO] Downloading from central: https://repo.maven.apache.org/maven2/org/springframework/boot/spring-boot-starter-parent/4.1.0/spring-boot-starter-parent-4.1.0.pom
      [INFO] Downloaded from central: https://repo.maven.apache.org/maven2/org/springframework/boot/spring-boot-starter-parent/4.1.0/spring-boot-starter-parent-4.1.0.pom (14 kB at 143 kB/s)
      [INFO] Downloading from central: https://repo.maven.apache.org/maven2/org/springframework/boot/spring-boot-dependencies/4.1.0/spring-boot-dependencies-4.1.0.pom
      [INFO] Downloaded from central: https://repo.maven.apache.org/maven2/org/springframework/boot/spring-boot-dependencies/4.1.0/spring-boot-dependencies-4.1.0.pom (142 kB at 3.2 MB/s)
      [INFO] Downloading from central: https://repo.maven.apache.org/maven2/org/apache/activemq/activemq-bom/6.2.6/activemq-bom-6.2.6.pom
      [INFO] Downloaded from central: https://repo.maven.apache.org/maven2/org/apache/activemq/activemq-bom/6.2.6/activemq-bom-6.2.6.pom (7.9 kB at 246 kB/s)
      [INFO] Downloading from central: https://repo.maven.apache.org/maven2/org/apache/artemis/artemis-bom/2.53.0/artemis-bom-2.53.0.pom
      [INFO] Downloaded from central: https://repo.maven.apache.org/maven2/org/apache/artemis/artemis-bom/2.53.0/artemis-bom-2.53.0.pom (18 kB at 552 kB/s)
      [INFO] Downloading from central: https://repo.maven.apache.org/maven2/org/apache/artemis/artemis-project/2.53.0/artemis-project-2.53.0.pom
      [INFO] Downloaded from central: https://repo.maven.apache.org/maven2/org/apache/artemis/artemis-project/2.53.0/artemis-project-2.53.0.pom (55 kB at 1.5 MB/s)
      [INFO] Downloading from central: https://repo.maven.apache.org/maven2/org/apache/apache/37/apache-37.pom
      [INFO] Downloaded from central: https://repo.maven.apache.org/maven2/org/apache/apache/37/apache-37.pom (26 kB at 596 kB/s)
      [INFO] Downloading from central: https://repo.maven.apache.org/maven2/org/assertj/assertj-bom/3.27.7/assertj-bom-3.27.7.pom
      [INFO] Downloaded from central: https://repo.maven.apache.org/maven2/org/assertj/assertj-bom/3.27.7/assertj-bom-3.27.7.pom (3.3 kB at 90 kB/s)
      ...
      [INFO] Downloaded from central: https://repo.maven.apache.org/maven2/io/zipkin/reporter2/zipkin-reporter-bom/3.5.3/zipkin-reporter-bom-3.5.3.pom (6.1 kB at 179 kB/s)
...
      ...
      [INFO] Downloaded from central: https://repo.maven.apache.org/maven2/org/apache/maven/resolver/maven-resolver-api/1.9.22/maven-resolver-api-1.9.22.pom (2.2 kB at 82 kB/s)
      ...
      [INFO] Downloaded from central: https://repo.maven.apache.org/maven2/org/codehaus/plexus/plexus-utils/4.0.1/plexus-utils-4.0.1.pom (7.8 kB at 313 kB/s)
      [INFO] Downloading from central: https://repo.maven.apache.org/maven2/org/codehaus/plexus/plexus/17/plexus-17.pom
      [INFO] Downloaded from central: https://repo.maven.apache.org/maven2/org/codehaus/plexus/plexus/17/plexus-17.pom (28 kB at 1.1 MB/s)
      ...
      [INFO] Downloaded from central: https://repo.maven.apache.org/maven2/org/apache/maven/resolver/maven-resolver-util/1.9.22/maven-resolver-util-1.9.22.jar (196 kB at 7.3 MB/s)
      [INFO] Downloaded from central: https://repo.maven.apache.org/maven2/org/apache/maven/resolver/maven-resolver-api/1.9.22/maven-resolver-api-1.9.22.jar (157 kB at 5.6 MB/s)
      [INFO] Downloaded from central: https://repo.maven.apache.org/maven2/org/codehaus/plexus/plexus-utils/4.0.1/plexus-utils-4.0.1.jar (193 kB at 6.6 MB/s)
      ...
      [INFO] Finished at: 2026-08-10T08:42:35Z
      [INFO] ------------------------------------------------------------------------

  - Done (14.0s)
- Running `./mvnw dependency:list` quietly
  - Done (9.3s)
- Done (finished in 23.4s)
...
df39a88acfc8   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
2026-08-10T08:42:52.686Z  INFO 1 --- [           main] c.heroku.java.GettingStartedApplication  : Starting GettingStartedApplication v1.0.0-SNAPSHOT using Java 17.0.20 with PID 1 (/workspace/target/java-getting-started-1.0.0-SNAPSHOT.jar started by heroku in /workspace)
2026-08-10T08:42:52.692Z  INFO 1 --- [           main] c.heroku.java.GettingStartedApplication  : No active profile set, falling back to 1 default profile: "default"
2026-08-10T08:42:53.655Z  INFO 1 --- [           main] o.s.boot.tomcat.TomcatWebServer          : Tomcat initialized with port 5006 (http)
2026-08-10T08:42:53.670Z  INFO 1 --- [           main] o.apache.catalina.core.StandardService   : Starting service [Tomcat]
2026-08-10T08:42:53.670Z  INFO 1 --- [           main] o.apache.catalina.core.StandardEngine    : Starting Servlet engine: [Apache Tomcat/11.0.22]
2026-08-10T08:42:53.698Z  INFO 1 --- [           main] b.w.c.s.WebApplicationContextInitializer : Root WebApplicationContext: initialization completed in 932 ms
2026-08-10T08:42:53.834Z  INFO 1 --- [           main] o.s.b.w.a.WelcomePageHandlerMapping      : Adding welcome page template: index
2026-08-10T08:42:54.154Z  INFO 1 --- [           main] o.s.boot.tomcat.TomcatWebServer          : Tomcat started on port 5006 (http) with context path '/'
2026-08-10T08:42:54.166Z  INFO 1 --- [           main] c.heroku.java.GettingStartedApplication  : Started GettingStartedApplication in 1.919 seconds (process running for 2.395)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
