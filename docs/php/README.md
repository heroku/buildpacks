<!-- STOP
  ...
  Command: /Users/rschneeman/.gem/ruby/3.3.1/bin/rundoc docs/src/php/RUNDOC.md
STOP -->
...
ecc553ef1a98   my-image-name                             latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
Number of CPU cores is 12
PHP memory_limit is 128M Bytes
Calculated number of workers based on RAM and CPU cores is 48
