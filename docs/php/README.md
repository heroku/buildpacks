...
a277bb6 Bump the php-dependencies group with 2 updates (#89)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Installing platform packages
  - Running `composer install --no-dev --no-interaction`
      ...
      Lock file operations: 26 installs, 0 updates, 0 removals
        ...
        - Locking heroku-sys/composer (2.8.11)
        - Locking heroku-sys/php (8.4.12)
      ...
      Package operations: 26 installs, 0 updates, 0 removals
        ...
        - Downloading heroku-sys/php (8.4.12)
        - Downloading heroku-sys/composer (2.8.11)
       0/2 [>---------------------------]   0%
       1/2 [==============>-------------]  50%
       2/2 [============================] 100%
        - Installing heroku-sys/php (8.4.12)
        - Installing fig/http-message-util (1.1.5)
        - Installing heroku-sys/composer (2.8.11)
...
5bc3332200d2   my-image-name    latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
