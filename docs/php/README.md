...
2553374 Bump the php-dependencies group with 3 updates (#92)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Installing dependencies
  ...
  Package operations: 22 installs, 0 updates, 0 removals
    ...
    - Downloading monolog/monolog (3.9.0)
    - Downloading psr/http-server-handler (1.0.2)
      Failed to download monolog/monolog from dist: The "https://api.github.com/repos/Seldaek/monolog/zipball/10d85740180ecba7896c87e06a166e0c95a0e3b6" file could not be downloaded (HTTP/2 504 )
      Now trying to download from source
    - Syncing monolog/monolog (3.9.0) into cache
      Failed to download psr/http-server-handler from dist: The "https://api.github.com/repos/php-fig/http-server-handler/zipball/84c4fb66179be4caaf8e97bd239203245302e7d4" file could not be downloaded (HTTP/2 504 )
      Now trying to download from source
    - Syncing psr/http-server-handler (1.0.2) into cache
    - Downloading slim/slim (4.15.1)
    - Downloading slim/slim (4.15.1)
    - Downloading slim/slim (4.15.1)
      Failed to download slim/slim from dist: The "https://api.github.com/repos/slimphp/Slim/zipball/887893516557506f254d950425ce7f5387a26970" file could not be downloaded (HTTP/2 504 )
      Now trying to download from source
    - Syncing slim/slim (4.15.1) into cache
    - Installing laravel/serializable-closure (v2.0.4): Extracting archive
    - Installing psr/log (3.0.2): Extracting archive
    - Installing monolog/monolog (3.9.0): Cloning 10d8574018 from cache
    - Installing nikic/fast-route (v1.3.0): Extracting archive
    - Installing psr/http-message (2.0): Extracting archive
    - Installing psr/http-server-handler (1.0.2): Cloning 84c4fb6617 from cache
    - Installing psr/http-server-middleware (1.0.2): Extracting archive
    - Installing psr/http-factory (1.1.0): Extracting archive
    - Installing psr/container (2.0.2): Extracting archive
    - Installing slim/slim (4.15.1): Cloning 8878935165 from cache
    ...
    - Installing slim/psr7 (1.8.0): Extracting archive
...
3a08bcd5f8dc   my-image-name    latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
