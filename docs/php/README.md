...
bd83c58 Add tests for Getting Started index page (#95)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- Installing dependencies
  ...
  Package operations: 22 installs, 0 updates, 0 removals
    ...
    - Installing slim/slim (4.15.1): Extracting archive
    ...
    - Installing twig/twig (v3.23.0): Extracting archive
...
3ea2102b5537   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
