...
- SDK installation
  - Downloading SDK from https://download.visualstudio.microsoft.com/download/pr/0e717d01-aad7-475a-8b67-50c59cf043b1/6eaa1c636e15ec8e1b97b3438360c770/dotnet-sdk-9.0.102-linux-x64.tar.gz .... (1.2s)
...
- Publish solution
  ...
  - Running `dotnet publish /workspace/GettingStarted.sln --runtime linux-x64 "-p:PublishDir=bin/publish"`
        ...
        Restored /workspace/Frontend/Frontend.csproj (in 7.65 sec).
...
4339a636c3da   my-image-name    latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
warn: Microsoft.AspNetCore.DataProtection.KeyManagement.XmlKeyManager[35]
      No XML encryptor configured. Key {3ca62155-958d-4930-ad45-63d94040d3f3} may be persisted to storage in unencrypted form.
...
- Publish solution
  ...
  - Running `dotnet publish /workspace/GettingStarted.sln --runtime linux-x64 "-p:PublishDir=bin/publish"`
        ...
        Determining projects to restore...
        Restored /workspace/Frontend/Frontend.csproj (in 6.92 sec).
        Frontend -> /workspace/Frontend/bin/Release/net9.0/linux-x64/Frontend.dll
        Frontend -> /workspace/Frontend/bin/publish/
        Restoring .NET tools
        Tool 'dotnet-ef' (version '8.0.12') was restored. Available commands: dotnet-ef
