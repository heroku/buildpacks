...
073a7f7 Add special CODEOWNERS case for dotnet-tools.json (#70)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- SDK version detection
  ...
  - Resolved .NET SDK version `9.0.300` (linux-amd64)
- SDK installation
  - Downloading SDK from https://builds.dotnet.microsoft.com/dotnet/Sdk/9.0.300/dotnet-sdk-9.0.300-linux-x64.tar.gz ... (0.7s)
...
- Publish app
  - Running `dotnet publish /workspace/GettingStarted.sln --runtime linux-x64 "-p:PublishDir=bin/publish" --artifacts-path /tmp/build_artifacts`
        ...
        Restored /workspace/Frontend/Frontend.csproj (in 6.24 sec).
...
48898e163ef7   my-image-name    latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
warn: Microsoft.AspNetCore.DataProtection.KeyManagement.XmlKeyManager[35]
      No XML encryptor configured. Key {23313fd0-81de-46fa-a3cc-d09c1c727d09} may be persisted to storage in unencrypted form.
...
- SDK version detection
  ...
  - Resolved .NET SDK version `9.0.300` (linux-amd64)
- SDK installation
  - Downloading SDK from https://builds.dotnet.microsoft.com/dotnet/Sdk/9.0.300/dotnet-sdk-9.0.300-linux-x64.tar.gz .... (1.3s)
  - Verifying SDK checksum
  - Installing SDK
- Restore .NET tools
  - Tool manifest file detected
