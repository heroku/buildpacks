...
b720e99 Explicitly set buildpack when creating app (#47)
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
- SDK installation
  - Downloading SDK from https://download.visualstudio.microsoft.com/download/pr/0e717d01-aad7-475a-8b67-50c59cf043b1/6eaa1c636e15ec8e1b97b3438360c770/dotnet-sdk-9.0.102-linux-x64.tar.gz ........................ (21.1s)
...
- Publish solution
  ...
  - Running `dotnet publish /workspace/GettingStarted.sln --runtime linux-x64 "-p:PublishDir=bin/publish"`
        ...
        Restored /workspace/Frontend/Frontend.csproj (in 6.8 sec).
...
1cc885ef2944   my-image-name    latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
warn: Microsoft.AspNetCore.DataProtection.KeyManagement.XmlKeyManager[35]
      No XML encryptor configured. Key {fc6c0166-321b-40b9-8e49-62b5877b6fcc} may be persisted to storage in unencrypted form.
...
- SDK version detection
  ...
  - Resolved .NET SDK version `9.0.102` (linux-amd64)
- SDK installation
  - Downloading SDK from https://download.visualstudio.microsoft.com/download/pr/0e717d01-aad7-475a-8b67-50c59cf043b1/6eaa1c636e15ec8e1b97b3438360c770/dotnet-sdk-9.0.102-linux-x64.tar.gz ........ (5.8s)
  - Verifying SDK checksum
  - Installing SDK
- Publish solution
  - Using `Release` build configuration
