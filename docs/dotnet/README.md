...
- SDK installation
  - Downloading SDK from https://builds.dotnet.microsoft.com/dotnet/Sdk/9.0.306/dotnet-sdk-9.0.306-linux-x64.tar.gz ..... (2.0s)
...
- Publish app
  - Running `dotnet publish /workspace/GettingStarted.sln --runtime linux-x64 "-p:PublishDir=bin/publish" --artifacts-path /tmp/build_artifacts`
        ...
        Restored /workspace/Frontend/Frontend.csproj (in 7.06 sec).
...
f325f72f09a0   my-image-name    latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
warn: Microsoft.AspNetCore.DataProtection.KeyManagement.XmlKeyManager[35]
      No XML encryptor configured. Key {26bef26c-fbfe-4c96-a920-1224ca16ee43} may be persisted to storage in unencrypted form.
...
- Publish app
  - Running `dotnet publish /workspace/GettingStarted.sln --runtime linux-x64 "-p:PublishDir=bin/publish" --artifacts-path /tmp/build_artifacts`
        ...
        Determining projects to restore...
        Restored /workspace/Frontend/Frontend.csproj (in 5.9 sec).
        Frontend -> /tmp/build_artifacts/bin/Frontend/release_linux-x64/Frontend.dll
        Frontend -> /workspace/Frontend/bin/publish/
        Publishing executable database migration bundle
        Build started...
