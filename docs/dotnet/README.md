...
- SDK installation
  - Downloading SDK from https://builds.dotnet.microsoft.com/dotnet/Sdk/10.0.102/dotnet-sdk-10.0.102-linux-x64.tar.gz .... (1.9s)
...
- Publish app
  - Running `dotnet publish /workspace/GettingStarted.slnx --runtime linux-x64 "-p:PublishDir=bin/publish" --artifacts-path /tmp/build_artifacts`
        ...
        Restored /workspace/Frontend/Frontend.csproj (in 4.32 sec).
...
ad13f006ec25   my-image-name                                latest
```
<!-- STOP. This document is autogenerated. Do not manually modify. See the top of the doc for more details. -->
...
warn: Microsoft.AspNetCore.DataProtection.KeyManagement.XmlKeyManager[35]
      No XML encryptor configured. Key {fe586b53-032d-4ec4-afbf-76b3764a8bcf} may be persisted to storage in unencrypted form.
...
- SDK version detection
  ...
  - Resolved .NET SDK version `10.0.102` (linux-amd64)
- SDK installation
  - Downloading SDK from https://builds.dotnet.microsoft.com/dotnet/Sdk/10.0.102/dotnet-sdk-10.0.102-linux-x64.tar.gz ........ (5.3s)
  - Verifying SDK checksum
  - Installing SDK
- Restore .NET tools
  - Tool manifest file detected
